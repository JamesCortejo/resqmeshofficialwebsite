...
async function initializeDatabase() {
  await exec(`
    ...
    CREATE TABLE IF NOT EXISTS online_chat_message_voice_clips (
      id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
      message_id INTEGER NOT NULL UNIQUE REFERENCES online_chat_messages(id) ON DELETE CASCADE,
    ...
    CREATE INDEX IF NOT EXISTS idx_online_chat_message_voice_clips_message ON online_chat_message_voice_clips (message_id);

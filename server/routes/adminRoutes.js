...
router.get('/device-map/online-distress', deviceManagerController.listDeviceMapOnlineDistress);
router.get('/device-map/shared-rescuers', deviceManagerController.listDeviceMapSharedRescuers);
router.get('/device-map/links', deviceManagerController.listDeviceMapLinks);
...
router.get('/distress-signals/active-count', adminDistressController.getActiveDistressSignalCount);
...
router.post('/reports/mesh-device-sync-health/generate', reportController.generateMeshDeviceSyncHealth);
router.post('/reports/online-communications-moderation/generate', reportController.generateOnlineCommunicationsModeration);
